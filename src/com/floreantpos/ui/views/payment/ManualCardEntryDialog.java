...
public class ManualCardEntryDialog extends POSDialog implements CardInputProcessor {
	...
	private void createUI() {
		...
		JLabel lblCvv = new JLabel("CVV"); //$NON-NLS-1$
		panel.add(lblCvv, "cell 0 3,alignx trailing"); //$NON-NLS-1$

		tfCvv = new POSTextField();
		tfCvv.setColumns(4);
		panel.add(tfCvv, "cell 1 3"); //$NON-NLS-1$
