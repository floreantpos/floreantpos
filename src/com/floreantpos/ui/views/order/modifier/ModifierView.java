...
public class ModifierView extends SelectionView {
	...
	public ModifierView(ModifierSelectionModel modifierSelectionModel) {
		super(com.floreantpos.POSConstants.MODIFIERS, PosUIManager.getSize(160), PosUIManager.getSize(90));
	...
	private static void applyCardStyle(PosButton btn) {
	...
	private void addActionButtons() {
		applyCardStyle(btnClear);
		applyCardStyle(btnDone);
