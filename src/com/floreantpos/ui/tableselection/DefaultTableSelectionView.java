...
public class DefaultTableSelectionView extends TableSelector implements ActionListener {
	...
	private void init() {
		...
		buttonsPanel = new ScrollableFlowPanel(FlowLayout.LEFT);
		((FlowLayout) buttonsPanel.getContentPane().getLayout()).setHgap(10);
		((FlowLayout) buttonsPanel.getContentPane().getLayout()).setVgap(10);
	...
	public synchronized void redererTables() {
		...
		for (ShopTable shopTable : tables) {
			...
			tableButton.setPreferredSize(PosUIManager.getSize(120, 115));
